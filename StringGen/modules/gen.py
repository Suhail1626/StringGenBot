...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@PrimeBotsUpdates"))
        else:
            ...
            await client.join_chat("PrimeBotsUpdates")
    except KeyError:
        pass
    try:
